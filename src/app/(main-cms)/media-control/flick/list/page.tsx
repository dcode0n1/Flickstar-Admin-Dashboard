...
import { MediaControlFlickListBreadCrumbs, staffListBreadCrumbData } from "@/constants/bread-crumbs";
...
import { MediaControlFlickListHeadings } from "@/constants/table-headings";
...
export default function MediaControlFlickList() {
  ...
  return (
    <div className="flex flex-1 flex-col bg-slate-100">
      <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
        <h1 className="text-sm font-bold text-gray-800">MANAGE FLICKS</h1>
        <CustomBreakCrumb data={MediaControlFlickListBreadCrumbs} />
      </div>
        ...
        >
          ...
          <div className="overflow-x-auto grid grid-cols-1">
            <Table>
              <TableHeader>
                <TableRow>
                  {MediaControlFlickListHeadings.map((heading, index) => {
