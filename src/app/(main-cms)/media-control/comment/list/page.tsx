...
import { MediaControlCommentListBreadCrumbs} from "@/constants/bread-crumbs";
...
import {  MediaControlCommentListHeadings } from "@/constants/table-headings";
...
export default function MediaControlCommentList() {
    ...
    return (
        <div className="flex flex-1 flex-col bg-slate-100">
            <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
                <h1 className="text-sm font-bold text-gray-800">MANAGE COMMENTS</h1>
                <CustomBreakCrumb data={MediaControlCommentListBreadCrumbs} />
            </div>
                ...
                >
                    ...
                    <div className="overflow-x-auto grid grid-cols-1">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    {MediaControlCommentListHeadings.map((heading, index) => {
                            ...
                            {isLoading ? (
                                <TableBody>
                                    <TableRow>
                                        <TableCell colSpan={MediaControlCommentListHeadings.length} className="text-center py-6">
