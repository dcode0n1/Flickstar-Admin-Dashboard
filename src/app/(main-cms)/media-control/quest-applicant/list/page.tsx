...
import {MediaControlQuestApplicantListBreadCrumbs} from "@/constants/bread-crumbs";
...
import { MediaControlQuestApplicantListHeadings } from "@/constants/table-headings";
...
export default function MediaControlQuestApplicantList() {
    ...
    return (
        <div className="flex flex-1 flex-col bg-slate-100">
            <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
                <h1 className="text-sm font-bold text-gray-800">MANAGE QUEST APPLICANTS</h1>
                <CustomBreakCrumb data={MediaControlQuestApplicantListBreadCrumbs} />
            </div>
            <div className="flex flex-1 flex-col m-4">
                <CardWrapper
                    name="Quest Applicant List"
                    viewBtn={false}
                ...
                >
                    ...
                    <div className="overflow-x-auto grid grid-cols-1">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    {MediaControlQuestApplicantListHeadings.map((heading, index) => {
                            ...
                            {isLoading ? (
                                <TableBody>
                                    <TableRow>
                                        <TableCell colSpan={MediaControlQuestApplicantListHeadings.length} className="text-center py-6">
