...
import { MediaControlAudioListBreadCrumbs, MediaControlSongListBreadCrumbs } from "@/constants/bread-crumbs";
...
import { MediaControlAudioListHeadings} from "@/constants/table-headings";
...
export default function MediaControlAudioList() {
    ...
    return (
        <div className="flex flex-1 flex-col bg-slate-100">
            <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
                <h1 className="text-sm font-bold text-gray-800">MANAGE AUDIO</h1>
                <CustomBreakCrumb data={MediaControlAudioListBreadCrumbs} />
            </div>
                ...
                >
                    ...
                    <div className="overflow-x-auto grid grid-cols-1">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    {MediaControlAudioListHeadings.map((heading, index) => {
                            ...
                            {isLoading ? (
                                <TableBody>
                                    <TableRow>
                                        <TableCell colSpan={MediaControlAudioListHeadings.length} className="text-center py-6">
