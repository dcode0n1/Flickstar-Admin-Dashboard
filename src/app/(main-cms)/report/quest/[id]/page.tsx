...
import { ReportQuestReplyBreadCrumbs } from '@/constants/bread-crumbs';
...
export default function ReportQuestId() {
  const { id } = useParams();
  ...
  return (
    <div className="flex flex-1 flex-col bg-slate-100">
      <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
        ...
        <CustomBreadCrumb data={ReportQuestReplyBreadCrumbs} />
      </div>
      <div className="flex flex-1 flex-col m-4">
        <CardWrapper name="Report Quest">
          <div className="p-4">
            <div className="p-2 bg-slate-100 space-y-2 max-h-[60vh] overflow-y-auto">
              <div className="space-x-2">
                ...
                <span className="text-xs">Quest Id - {data?.SUPPORTTICKET?.ticketId}</span>
              </div>
