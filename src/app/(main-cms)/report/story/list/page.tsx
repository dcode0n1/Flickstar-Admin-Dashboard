...
import { ReportQuestListBreadcrumbs, ReportStoryListBreadcrumbs } from "@/constants/bread-crumbs";
...
import { ReportStoryListHeadings } from "@/constants/table-headings";
...
export default function ReportStoryList() {
  ...
  return (
    <div className="flex flex-1 flex-col bg-slate-100">
      <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
        <h1 className="text-sm font-bold text-gray-800">REPORT STORY</h1>
        <CustomBreakCrumb data={ReportStoryListBreadcrumbs} />
      </div>
      <div className="flex flex-1 flex-col m-4">
        <CardWrapper
          name="Report Story List"
          viewBtn={false}
          className="p-2"
        >
          ...
          <div className="overflow-x-auto grid grid-cols-1">
            <Table>
              <TableHeader>
                <TableRow>
                  {ReportStoryListHeadings.map((heading, index) => {
              ...
              {isLoading ? (
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={ReportStoryListHeadings.length} className="text-center py-6">
