...
import { ReportAudioListBreadcrumbs } from "@/constants/bread-crumbs";
...
import { ReportAudioListHeadings } from "@/constants/table-headings";
...
export default function ReportAudioList() {
  ...
  return (
    <div className="flex flex-1 flex-col bg-slate-100">
      <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
        <h1 className="text-sm font-bold text-gray-800">REPORT AUDIO</h1>
        <CustomBreakCrumb data={ReportAudioListBreadcrumbs} />
      </div>
      <div className="flex flex-1 flex-col m-4">
        <CardWrapper
          name="Report Audio List"
          viewBtn={false}
          className="p-2"
        >
          ...
          <div className="overflow-x-auto grid grid-cols-1">
            <Table>
              <TableHeader>
                <TableRow>
                  {ReportAudioListHeadings.map((heading, index) => {
              ...
              {isLoading ? (
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={ReportAudioListHeadings.length} className="text-center py-6">
