...
import { ReportFlickListBreadcrumbs, ReportQuestListBreadcrumbs } from "@/constants/bread-crumbs";
...
import { ReportFlickListHeadings } from "@/constants/table-headings";
...
export default function ReportFlickList() {
  ...
  return (
    <div className="flex flex-1 flex-col bg-slate-100">
      <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
        ...
        <CustomBreakCrumb data={ReportFlickListBreadcrumbs} />
      </div>
      <div className="flex flex-1 flex-col m-4">
        <CardWrapper
          name="Report Flick List"
          viewBtn={false}
          className="p-2"
        >
          ...
          <div className="overflow-x-auto grid grid-cols-1">
            <Table>
              <TableHeader>
                <TableRow>
                  {ReportFlickListHeadings.map((heading, index) => {
              ...
              {isLoading ? (
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={ReportFlickListHeadings.length} className="text-center py-6">
