...
import {  ReportStoryListBreadcrumbs, ReportUserListBreadCrumbs } from "@/constants/bread-crumbs";
    ...
    return (
        <div className="flex flex-1 flex-col bg-slate-100">
            <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
                <h1 className="text-sm font-bold text-gray-800">REPORT USER</h1>
                <CustomBreakCrumb data={ReportUserListBreadCrumbs} />
            </div>
