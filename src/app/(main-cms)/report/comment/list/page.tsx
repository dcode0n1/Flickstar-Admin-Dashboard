...
import { ReportCommentListBreadcrumbs } from "@/constants/bread-crumbs";
...
import { ReportCommentListHeadings } from "@/constants/table-headings";
  ...
  return (
    <div className="flex flex-1 flex-col bg-slate-100">
      <div className="align-center flex justify-between p-4 border-b shadow-md bg-white">
        <h1 className="text-sm font-bold text-gray-800">REPORT COMMENTS</h1>
        <CustomBreakCrumb data={ReportCommentListBreadcrumbs} />
      </div>
        ...
        >
          ...
          <div className="overflow-x-auto grid grid-cols-1">
            <Table>
              <TableHeader>
                <TableRow>
                  {ReportCommentListHeadings.map((heading, index) => {
              ...
              {isLoading ? (
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={ReportCommentListHeadings.length} className="text-center py-6">
